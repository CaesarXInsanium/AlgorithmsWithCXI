...
static void rotate_left(BiTreeNode **node) {
  ...
  if (((AvlNode *)bitree_data(left))->factor == AVL_LFT_HEAVY) {
    ...
    *node = left;
    ...
    case AVL_LFT_HEAVY:
      ((AvlNode *)bitree_data(*node))->factor = AVL_RHT_HEAVY;
      ((AvlNode *)bitree_data(left))->factor = AVL_BALANCED;
      break;
    case AVL_BALANCED:
      ((AvlNode *)bitree_data(*node))->factor = AVL_BALANCED;
...
static void rotate_right(BiTreeNode **node) {
  ...
  if (((AvlNode *)bitree_data(right))->factor == AVL_RHT_HEAVY) {
    ...
    *node = right;
    ...
    case AVL_LFT_HEAVY:
      ((AvlNode *)bitree_data(*node))->factor = AVL_BALANCED;
      ((AvlNode *)bitree_data(right))->factor = AVL_RHT_HEAVY;
      break;
    case AVL_BALANCED:
      ((AvlNode *)bitree_data(*node))->factor = AVL_BALANCED;
      ((AvlNode *)bitree_data(right))->factor = AVL_BALANCED;
...
int bistree_lookup(const BisTree *tree, const void **data) {
  return lookup((BisTree *)tree, bitree_root(tree), (void *)data);
}

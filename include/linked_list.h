...
// Destroy function is used to handle DYNAMICALLY allocated elements and DATA. Generally
// free() Will create data structure but with not elements. head and tail are
// NULL
